...
class KeyGenerator(object):
    ...
    def render(self):
        tk.Label(self.root, text='KEY GENERATOR').grid(row=1, column=1, columnspan=2)
        ...
        self.text_field.grid(row=6, column=1, columnspan=2, sticky='news')
        self.text_field.config(state='readonly')
        
        tk.Button(self.root, text='GENERATE', command=self.generate_key).grid(row=7, column=1, columnspan=2, sticky='news')
